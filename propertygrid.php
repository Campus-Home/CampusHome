					...
					<div class="col-lg-8">
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
							...
							if(isset($_REQUEST['filter']))
							{
								...
								$sql="SELECT property.*, user.uname FROM `property`,`user` WHERE property.uid=user.uid and type='{$type}' and stype='{$stype}' and street='{$street}'";
								//SELECT * FROM `property` WHERE type='office' or type='office' and stype='sale' or stype='rent' and street='valsad' OR state='mumbai'
								//SELECT * FROM `property` WHERE type='office' and stype='sale'  and street='valsad' OR state='mumbai'
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                        ...
                                        <div class="price text-primary text-capitalize">Php <?php echo $row['11'];?> <span class="text-white"><?php echo $row['10'];?> Sqft</span></div>
