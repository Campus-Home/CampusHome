                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our selling service offers a seamless experience for homeowners looking to sell their properties quickly and at the best market value. We handle everything from listing to closing, ensuring a stress-free transaction.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our rental service connects tenants with their ideal rental homes and assists landlords in managing their properties efficiently. Enjoy a hassle-free rental experience with our comprehensive support and management solutions.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Discover your next home with our extensive property listings, featuring detailed descriptions, high-quality photos, and virtual tours. Find the perfect property that matches your needs and preferences with ease.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>Php <?php echo $row['11'];?> </b><span class="text-white"><?php echo $row['10'];?> Sqft</span></div>
                                            </div>
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    ...
                                                    <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-success"></i> <?php echo $row['12'];?></span> </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Choose us because our top-rated services reflect our commitment to excellence, with countless satisfied clients and glowing reviews highlighting our dedication to customer satisfaction.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We prioritize quality in every aspect of our service, ensuring that you receive meticulous attention to detail, superior support, and exceptional results, making your real estate journey smooth and successful.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team of experienced agents brings a wealth of knowledge and expertise to the table, providing you with insightful guidance and professional advice to help you make informed real estate decisions.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Our initial discussion is designed to understand your housing needs and preferences. We'll talk about your desired location, budget, type of accommodation, and any specific amenities or features you need. This helps us tailor our search to find the most suitable options for you.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>During the files review stage, we meticulously check all relevant documents to ensure everything is in order. This includes verifying lease agreements, conducting background checks on landlords, and reviewing property inspection reports. Our goal is to ensure that all legal and safety requirements are met before you proceed.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>The final step is acquiring your chosen accommodation. We'll assist you in finalizing and signing the lease or rental agreements, managing the payment process for deposits and rent, and coordinating your move-in date. We aim to make this transition as smooth and hassle-free as possible, ensuring you can settle into your new home with ease.</p>
                        </div>
                    </div>
                </div>
            </div>
