<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/campushome.png" alt="image" height="50"></a> </div>
                                        <p class="pb-20 text-white">Your ultimate companion in finding the perfect student accommodation. Whether you're a first-year student, a returning upperclassman, or an international student embarking on a new journey, Dorm Hunt is here to simplify the process of securing your ideal living space.</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>2058 LSD Bldg., Ligaya St., Brgy. 426 Zone 043 Sta. Mesa, Manila</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>09473060640</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>info@campushome.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Campus Home - Developed by BEAD </span> </div>
                    <div class="col-sm-6">
                        <ul class="line-menu text-white hover-text-primary float-right">
                            <li><a href="#">Privacy & Policy</a></li>
                            <li>|</li>
                            <li><a href="https://maps.app.goo.gl/RdHnSaAy8CbQZpwE7"> Site Map</a></li>
                        </ul>
                    </div>
                </div>
            </div>
