                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="property-info d-table">
                                        ...
                                        <!-- property address -->
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-success font-13"></i>&nbsp; <?php echo $row['12'];?></span>
                                        <!-- property price -->
                                        <div class="price mt-3">
											<span class="text-success">Php&nbsp;<?php echo $row['11'];?></span>
										</div>
                                    </div>
								</td>
                                <!-- selling type -->
                                <td>For <?php echo $row['4'];?></td>
                                <!-- date added -->
                                <td class="text-capitalize"><?php echo $row['25'];?></td>
                                <!-- status -->
								<td class="text-capitalize"><?php echo $row['21'];?></td>
