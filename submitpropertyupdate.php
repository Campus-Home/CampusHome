...
if(isset($_POST['add']))
{
	...
	bedroom='{$bed}', bathroom='{$bath}', balcony='{$balc}', kitchen='{$kitc}', commonarea='{$commonarea}',
	size='{$asize}', price='{$price}', location='{$loc}', street='{$street}', feature='{$feature}',
										...
										<div class="row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<select class="form-control" required name="ptype">
														...
														<option value="flat" <?php if($row[3] == 'flat') echo 'selected'; ?>>Condominium</option>
														<option value="building" <?php if($row[3] == 'building') echo 'selected'; ?>>Dormitory</option>
												...
												<div class="form-group row">
													...
													<select class="form-control" required name="stype">
														<option value="rent" <?php if($row[4] == 'rent') echo 'selected'; ?>>Rent</option>
														<option value="sale" <?php if($row[4] == 'sale') echo 'selected'; ?>>Sale</option>
													</select>
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6"><!-- FOR MORE PROJECTS visit: codeastro.com -->
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="commonarea" required value="<?php echo $row['9']; ?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="street" required value="<?php echo $row['13']; ?>">
													</div>
												</div>
											</div><!-- FOR MORE PROJECTS visit: codeastro.com -->
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="asize" required value="<?php echo $row['10']; ?>">
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['17'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<select class="form-control" required name="status">
														<option value="available" <?php if($row[21] == 'available') echo 'selected'; ?>>Available</option>
														<option value="sold out" <?php if($row[21] == 'sold out') echo 'selected'; ?>>Sold Out</option>
													</select>
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['24'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<select class="form-control" required name="isFeatured">
														<option value="0" <?php if($row[26] == '0') echo 'selected'; ?>>No</option>
														<option value="1" <?php if($row[26] == '1') echo 'selected'; ?>>Yes</option>
													</select>
													</div>
												</div>
											</div>
